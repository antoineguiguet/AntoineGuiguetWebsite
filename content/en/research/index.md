...
sections:
  ...
  - block: markdown
    id: sex-determination-gall-wasps
    content:
      title:
      subtitle:
      text: |
        ...
        **Main collaborator:** Antoine Branca (Université Paris-Saclay)
        ...
        ![Illustration: sex determination in heterogonic gall wasps](/media/project-sex-determination.jpg)
  ...
  - block: collection
    content:
      ...
      count: 0
      filters:
        category: sex-determination-gall-wasps
      order: desc
  ...
  - block: collection
    content:
      ...
      count: 0
      filters:
        category: cynipid-gall-morphology
      order: desc
      page_type: publication
    design:
      view: compact
    ...
    content:
      ...
      text: |
        ...
        **Main collaborators:** Heather Hines, John Tooker, Andy Deans (Penn State University)
        ...
        ![Illustration: evolution and molecular bases of gall induction in Cynipidae](/media/project-cynipidae-induction.jpg)
  ...
  - block: collection
    content:
      ...
      count: 0
      filters:
        category: cynipidae-gall-induction
      order: desc
      page_type: publication
    design:
      view: compact
  ...
  - block: markdown
    id: gracillariidae-gall-induction
    content:
      title:
      subtitle:
      text: |
  ...
  - block: collection
    content:
      ...
      count: 0
      filters:
        category: gracillariidae-gall-induction
      order: desc
      page_type: publication
    design:
      view: compact
